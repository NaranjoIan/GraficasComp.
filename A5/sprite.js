function sprite () {
    this.width = 3695; // ****el ancho todal de mi spritesheet***
    this.height = 392; // ***el alto de mi spritesheet ***
    this.x = 0;
    this.y = 0;
    this.radius = 390; //***esta medida es lo que mide el ancho de un sprite (un frame del spritesheet)***
    this.vx = 0;
    this.vy = 0;
    this.rotation = 0;
    this.scaleX = 1;
    ...
    var numberOfFrames = 10; //*** El numero de frames que tiene mi spritesheet***
  ...
  sprite.prototype.draw = function (context) {
    ...
    marioImage.src = "WAWA-sp.png"; // ***el nombre de tu imagen***
    update();
    context.save();
